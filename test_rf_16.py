# test_rf_16.py
# Train RF and MLP using only 16 features (first 16 columns after the target)
...
# ===============================
# LOAD DATA AND SELECT FIRST 16 FEATURES
# ===============================
...
if os.path.exists("data/X_train.npy") and os.path.exists("data/X_test.npy"):
    ...
    # Keep only first 16 features
    X_train = X_train_full[:, :16]
    X_test = X_test_full[:, :16]
    print(f"Reduced from {X_train_full.shape[1]} to 16 features")
    ...
    joblib.dump(scaler, "models/scaler_16feat.pkl")
    
    np.save("data/X_train_16feat.npy", X_train)
    np.save("data/X_test_16feat.npy", X_test)
    np.save("data/y_train_16feat.npy", y_train)
    np.save("data/y_test_16feat.npy", y_test)
    
    print("Rebuilt and saved splits with 16 features.")

print("\n" + "="*70)
print("DATA INFORMATION (FIRST 16 FEATURES ONLY)")
print("="*70)
...
# ===============================
# RANDOM FOREST MODEL (16 FEATURES)
# ===============================
print("\n" + "="*70)
print("RANDOM FOREST MODEL (16 features)")
print("="*70)
...
# Save model (optional)
joblib.dump(rf, "models/rf_16feat_model.pkl")
print("\n[SAVED] models/rf_16feat_model.pkl")

# ===============================
# MLP MODEL (16 FEATURES)
# ===============================
print("\n" + "="*70)
print("MLP MODEL (16 features)")
print("="*70)
...
# Save model
joblib.dump(mlp, "models/mlp_16feat_model.pkl")
print("\n[SAVED] models/mlp_16feat_model.pkl")

print("\n" + "="*70)
print("COMPLETED - Both models trained on 16 features")
print("="*70)
